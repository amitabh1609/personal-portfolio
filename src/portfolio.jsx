...
const data = {
  ...
  skills: [
    ...
    { name: "LightGBM",              icon: "🌳",                                                                                      category: "Analytics & BI",     isImg: false },
    { name: "Evidently AI",          icon: "📉",                                                                                      category: "Analytics & BI",     isImg: false },
    ...
    { name: "MLflow",                icon: "📊",                                                                                      category: "Infra & Dev",        isImg: false },
  ...
  projects: [
    {
      ...
      type: "AI / Safety",
      highlight: "▸ 50-question adversarial benchmark · 10/10 injection tests blocked · back-translation hallucination detection",
      description: "NL-to-SQL system over a supply chain PostgreSQL database with multi-layer safety — sqlparse AST guardrails hard-block DDL/DML and injection; PostgreSQL SET TRANSACTION READ ONLY as a database-enforced fallback. 100% guardrail block rate on 10 seeded injection tests; 100% execution accuracy on a 50-question adversarial benchmark. Back-translation hallucination detection via MiniLM-L6 cosine similarity; 6 Architecture Decision Records.",
    ...
    },
    {
      ...
      type: "ML / MLOps",
      highlight: "▸ 500 SKUs · 34.9% WAPE · 82.6% interval coverage · 46% over best baseline",
      description: "End-to-end demand forecasting for 500 spare-parts SKUs — QuantileLightGBM (P10/P50/P90) via walk-forward CV achieves 34.9% WAPE and 82.6% interval coverage (46% over best baseline). Versioned Parquet feature store with 33 hand-crafted features; MLflow model registry with promotion gate; Evidently AI drift monitoring. GitHub Actions CI/CD automated retraining pipeline.",
    ...
    },
    {
      ...
      type: "AI / RAG",
      highlight: "▸ 50-question adversarial benchmark · 0.86 RAGAS faithfulness · CI eval gate · Live on Render",
      description: "Production RAG pipeline over Snowflake and dbt documentation — dense retrieval (BGE-large, Qdrant) fused with BM25 via RRF (k=60); BGE cross-encoder reranker; Claude Haiku query rewriter. 50-question adversarial benchmark across 4 tiers; best config achieves 0.86 RAGAS faithfulness on conceptual queries; CI eval gate fails build on faithfulness regression. All retrievals traced in Langfuse; live on Render.",
      tech: ["BGE-large", "BM25/RRF", "Qdrant", "RAGAS", "Claude Sonnet", "Langfuse", "GitHub Actions", "Docker", "Render"],
      color: "#48CAE4",
      emoji: "🔍",
      link: "https://github.com/amitabh1609/Evaluated_Rag_Snowflake_DBT",
      demoLink: "https://evaluated-rag-snowflake-dbt.onrender.com",
    },
    {
      ...
      description: "Bronze/Silver/Gold Iceberg lakehouse ingesting 7.4M+ GitHub Archive events — manifest-tracked, crash-resumable pipeline with Silver-layer deduplication, 15 event-type payload parsing, and quarantine routing of ~600 malformed rows. 36 Soda Core data quality checks gate every Dagster run; Software-Defined Assets with full lineage. Iceberg time-travel demonstrated on a 3.8M-row table; 5 documented failure scenarios with recovery commands.",
